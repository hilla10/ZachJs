...
function showMeme() {
    ...
    container = document.querySelector('.meme-content');
...
function showJoke() {
    ...
    container = document.querySelector('.joke-content');
    let jokeContent = document.createElement('p');
    jokeContent.innerHTML += randomJokeText;
    clearAll();
    container.appendChild(jokeContent);
}
...
function revealAnswers() {
    ...
    if (riddle && answer.hidden) {
        ...
        error.textContent += 'The answer is already revealed'
        ...
        const container = document.querySelector('.riddle-content');
        error = document.createElement('p');
        error.textContent += 'There\'s no riddle to reveal the answer to'
        error.style.color = "red";
        clearAll();
        container.appendChild(error);
    }
